...
";
	...
	override void update() {
		...
		screen.cprint(area.x + 1, y++,15, 0,"(C) 2009-20 Abaddon + contributors".center(area.width-2));
		screen.cprint(area.x + 1, y++,15, 0,"reSID engine by Dag Lem, reSIDfp engine by Leandro Nini".center(area.width-2));
